    ...
    <div className="page-shell barista-signup-page">
      <section className="page-hero">
        <div className="container">
          <div className="section-label"><Coffee size={14} style={{ display: 'inline', marginRight: 6 }} /> For Baristas</div>
          <h1 className="page-title">Get discovered. It&rsquo;s free.</h1>
          ...
          <div className="signup-trust-row">
            <span className="signup-trust"><ShieldCheck size={14} /> Free to list, free forever</span>
            <span className="signup-trust"><Sparkles size={14} /> Takes about 3 minutes</span>
            <span className="signup-trust"><Coffee size={14} /> No middleman &mdash; cafes call you directly</span>
          </div>
        </div>
      </section>
