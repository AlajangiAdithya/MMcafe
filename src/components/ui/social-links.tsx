            ...
            return (
              ...
              >
                <a
                  ...
                  style={{ backgroundColor: 'hsl(24 10% 8%)' }}
                >
                  <div
        ...
        <div className="lg:hidden fixed bottom-6 right-6 z-50">
          {mobileDockOpen && (
            <div
              ...
              style={{ backgroundColor: 'hsla(25, 11%, 3%, 0.6)' }}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute top-1/2 -translate-y-1/2 right-16
                         ...
                         style={{ backgroundColor: 'hsl(24 10% 8%)', color: '#EAE6DF' }}>
                      {style.label}
                      <div className="absolute top-1/2 -translate-y-1/2 -right-1 w-2 h-2 rotate-45"
                           style={{ backgroundColor: 'hsl(24 10% 8%)' }} />
                    </div>
                  </a>
                );
